...
setup() {
  ...
  _DM__GLOBAL__CONFIG__CACHE__VARIABLES_FILE="${DM__TEST__TEST_DIR}/var_cache"
  _DM__GLOBAL__CONFIG__TEMP__VARIABLES_FILE="${DM__TEST__TEST_DIR}/tmp_file"

  touch "$_DM__GLOBAL__CONFIG__CACHE__VARIABLES_FILE"
  touch "$_DM__GLOBAL__CONFIG__TEMP__VARIABLES_FILE"

  export DM__GLOBAL__CONFIG__CACHE__VARIABLES_FILE=$( \
    realpath --relative-to="$(pwd)" "$_DM__GLOBAL__CONFIG__CACHE__VARIABLES_FILE" \
  )
  export DM__GLOBAL__CONFIG__TEMP__VARIABLES_FILE=$( \
    realpath --relative-to="$(pwd)" "$_DM__GLOBAL__CONFIG__TEMP__VARIABLES_FILE" \
  )
...
@test "variables - variables can be loaded" {
  ...
  run cat "$_DM__GLOBAL__CONFIG__CACHE__VARIABLES_FILE"
